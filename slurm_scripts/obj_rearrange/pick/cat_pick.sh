...
export ENVS=16
export GPUS=8
export EXP_NAME=cat_pick_dev/visual_priors/new_inits/cat_rearrange_easy_rgbd_${VIS_RES}_res_${ENVS}x${GPUS}_envs
mkdir -p slurm_logs/${EXP_NAME}
export SENSORS="['HEAD_DEPTH_SENSOR','HEAD_RGB_SENSOR']"
export OBS_KEYS="['robot_head_depth','robot_head_rgb','joint','is_holding','object_category','relative_resting_position']"
