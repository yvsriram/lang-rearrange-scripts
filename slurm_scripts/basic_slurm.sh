...
#SBATCH -x conroy,cheetah,heistotron,chappie,xaea-12,gundam,kitt,tachikoma,baymax
...
srun python -u  -m habitat_baselines.run  \
    ...
    habitat_baselines.wb.entity=language-rearrangement habitat_baselines.wb.project_name=e2e-ovmm ${MORE_OPTIONS} habitat_baselines.writer_type=wb
