...
export EXP_NAME=multi_task/input_${INPUTS}_${ENVS}x${GPUS_PER_NODE}x${NODES}_envs_${EPS_KEY}_no_augs_${NO_AUGS}_navmesh_pen_${NAVMESH_PEN}_cont_actions_${CONT_ACTIONS}_place_only_max_${MAX_COLLS}_colls_constraint_base_${CONSTRAINT_BASE_IN_MANIP_MODE}_coll_pen_${COLL_PEN}
...
# ENVS=1
# export EXP_NAME=${EXP_NAME}_debug_more_actions
