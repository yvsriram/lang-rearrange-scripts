...
export OBS_KEYS="['head_rgb','start_receptacle','object_embedding','joint']"
...
export EXP_NAME="${EXP_NAME}-success_dist_${gaze_distance}"_no_augs_${NO_AUGS}_train_long_fixed_robust_states

export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.spawn_reference=receptacle_center habitat.task.spawn_max_dist_to_obj=2.0 habitat.task.base_angle_noise=3.14"
