...
export EXP_NAME=place/input_${INPUTS}_${ENVS}x${GPUS_PER_NODE}x${NODES}_envs_${EPS_KEY}_no_colls_term_no_augs_no_vel_thresh_kinematic_mode_no_force_terminate
