...
export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.measurements.object_at_rest.angular_vel_thresh=1e-3  habitat.task.measurements.object_at_rest.linear_vel_thresh=1e-3"
