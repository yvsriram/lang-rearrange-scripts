...
export PRETRAINED_PATH="data/new_checkpoints/find_obj/input_goal_recep_depth_wout_recep_seg_16x1x8_envs_new_train_explore_reward_0.0_no_augs_false_navmesh_pen_0.0_cont_actions_false_reward_turn_true_use_iou_true_dropout_0.0/ckpt.5.pth"
...
export EXP_NAME=find_obj/input_${INPUTS}_${ENVS}x${GPUS_PER_NODE}x${NODES}_envs_${EPS_KEY}_explore_reward_${EXPLORE_REWARD}_no_augs_${NO_AUGS}_navmesh_pen_${NAVMESH_PEN}_cont_actions_${CONT_ACTIONS}_reward_turn_${REWARD_TURN}_use_iou_${USE_IOU}_ckpt_5_fixed_yes_c014d_stashed
