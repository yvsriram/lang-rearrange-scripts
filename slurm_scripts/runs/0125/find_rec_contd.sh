...
export PRETRAINED_PATH="data/new_checkpoints/ovmm_new/input__16x1x8_envs_new_train_no_augs_false_navmesh_pen_0.0_cont_actions_true_v2_max_-1_coll_pen_0.0_mobile_place_false_call_stop_true_constraint_base_false_updated_350_steps_dropout_0.0/ckpt.5.pth"
