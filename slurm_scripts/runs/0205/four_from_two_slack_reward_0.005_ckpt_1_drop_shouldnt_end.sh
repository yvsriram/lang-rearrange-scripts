...
export PRETRAINED_PATH="data/new_checkpoints/ovmm_new/input__16x1x8_envs_new_train_no_augs_false_navmesh_pen_0.0_cont_actions_true_v2_max_-1_coll_pen_0.0_mobile_place_false_call_stop_false_constraint_base_false_two_steps_ckpt_2_drop_shldnt_end_dropout_0.0_pretrained_warm_start/ckpt.1.pth"
...
export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.success_measure=ovmm_place_success habitat.task.skills_completed_at_start=0 habitat.task.object_in_hand_sample_prob=0.0"


export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.measurements.ovmm_place_reward.wrong_drop_should_end=False"
