...
export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.success_measure=ovmm_find_recep_phase_success habitat.task.skills_completed_at_start=1 habitat.task.object_in_hand_sample_prob=0.0"
