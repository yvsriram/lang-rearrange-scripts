...
export EXP_NAME=end_to_end/input_${INPUTS}_${ENVS}x${GPUS_PER_NODE}x${NODES}_envs_${EPS_KEY}_no_augs_${NO_AUGS}_navmesh_pen_${NAVMESH_PEN}_cont_actions_${CONT_ACTIONS}_v2_max_${MAX_COLLS}_coll_pen_${COLL_PEN}_find_obj
...
export MORE_OPTIONS="${MORE_OPTIONS} habitat.task.success_measure=ovmm_find_object_phase_success"
